...
# ========== MODEL FILE OPTIONS ==========
BINARY_MODELS = {
    "Logistic Regression": "binary-models/whis_binary_logistic_regression_model.pkl",
    "SVM": "binary-models/whis_binary_svm_model.pkl",
    "Perceptron": "binary-models/whis_binary_perceptron_model.pkl",
    "DNN (Keras)": "binary-models/whis_dnn_binary_model.h5",
}

MULTILABEL_MODELS = {
    "Logistic Regression": "multi-label-classifier/whis_multi-label_logistic_regression_model.pkl",
    "SVM": "multi-label-classifier/whis_multi-label_svm_model.pkl",
    "Perceptron (Batch)": "multi-label-classifier/whis_multi-label_perceptron_batch_model.pkl",
    "Perceptron (Online)": "multi-label-classifier/whis_multi-label_perceptron_online_model.pkl",
    "DNN (Keras)": "multi-label-classifier/whis_multi-label_dnn_model.h5",
}
